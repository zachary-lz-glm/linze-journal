...
**前端工程**:React + TypeScript · Node.js Serverless BFF · 组件库设计(Rollup 双模打包 + Changesets)· Lerna + Nx Monorepo · Schema 驱动架构 · 微前端(qiankun)
...
- 三 plan 完整闭环 — 一次蒸馏产出 plan.md 三段式(开发计划精确到行号 + QA 矩阵 + 回滚方案) + final-quality-gate 5 维准出报告,区别于单点 PRD→Plan 工具
